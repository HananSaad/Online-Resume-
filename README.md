...
4. You need a refresher on JavaScript syntax, search to the [Javascript Basics], if you would like to understand how this project is manipulating and traversing the DOM, check out [Intro to jQuery]
